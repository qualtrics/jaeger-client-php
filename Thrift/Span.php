...
class Span {
  ...
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\SpanRef[]
   */
  ...
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\Tag[]
   */
  public $tags = null;
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\Log[]
   */
  public $logs = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        6 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Shared\Libraries\Jaeger\Thrift\SpanRef',
            ),
          ),
        7 => array(
          'var' => 'flags',
        ...
        10 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Shared\Libraries\Jaeger\Thrift\Tag',
            ),
          ),
        11 => array(
          'var' => 'logs',
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Shared\Libraries\Jaeger\Thrift\Log',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        ...
        case 6:
          if ($ftype == TType::LST) {
            ...
            {
              $elem12 = null;
              $elem12 = new \Shared\Libraries\Jaeger\Thrift\SpanRef();
        ...
        case 10:
          if ($ftype == TType::LST) {
            ...
            {
              $elem18 = null;
              $elem18 = new \Shared\Libraries\Jaeger\Thrift\Tag();
        ...
        case 11:
          if ($ftype == TType::LST) {
            ...
            {
              $elem24 = null;
              $elem24 = new \Shared\Libraries\Jaeger\Thrift\Log();
