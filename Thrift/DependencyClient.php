...
class DependencyClient implements \Shared\Libraries\Jaeger\Thrift\DependencyIf {
  ...
  {
    $args = new \Shared\Libraries\Jaeger\Thrift\Dependency_getDependenciesForTrace_args();
  ...
  public function recv_getDependenciesForTrace()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Shared\Libraries\Jaeger\Thrift\Dependency_getDependenciesForTrace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Shared\Libraries\Jaeger\Thrift\Dependency_getDependenciesForTrace_result();
  ...
  public function send_saveDependencies(\Shared\Libraries\Jaeger\Thrift\Dependencies $dependencies)
  {
    $args = new \Shared\Libraries\Jaeger\Thrift\Dependency_saveDependencies_args();
