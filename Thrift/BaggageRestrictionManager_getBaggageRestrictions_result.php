...
class BaggageRestrictionManager_getBaggageRestrictions_result {
  ...
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\BaggageRestriction[]
   */
  public $success = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Shared\Libraries\Jaeger\Thrift\BaggageRestriction',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Shared\Libraries\Jaeger\Thrift\BaggageRestriction();
