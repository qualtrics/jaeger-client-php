...
class AgentClient implements \Shared\Libraries\Jaeger\Thrift\AgentIf {
  ...
  {
    $args = new \Shared\Libraries\Jaeger\Thrift\Agent_emitZipkinBatch_args();
    $args->spans = $spans;
  ...
  public function emitBatch(\Shared\Libraries\Jaeger\Thrift\Batch $batch)
  {
    $this->send_emitBatch($batch);
  }

  public function send_emitBatch(\Shared\Libraries\Jaeger\Thrift\Batch $batch)
  {
    $args = new \Shared\Libraries\Jaeger\Thrift\Agent_emitBatch_args();
    $args->batch = $batch;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
