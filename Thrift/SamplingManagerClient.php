...
class SamplingManagerClient implements \Shared\Libraries\Jaeger\Thrift\SamplingManagerIf {
  ...
  {
    $args = new \Shared\Libraries\Jaeger\Thrift\SamplingManager_getSamplingStrategy_args();
  ...
  public function recv_getSamplingStrategy()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Shared\Libraries\Jaeger\Thrift\SamplingManager_getSamplingStrategy_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Shared\Libraries\Jaeger\Thrift\SamplingManager_getSamplingStrategy_result();
