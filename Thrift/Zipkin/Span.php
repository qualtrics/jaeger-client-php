...
class Span {
  ...
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\Zipkin\Annotation[]
   */
  public $annotations = null;
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\Zipkin\BinaryAnnotation[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        6 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Shared\Libraries\Jaeger\Thrift\Zipkin\Annotation',
            ),
          ),
        8 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Shared\Libraries\Jaeger\Thrift\Zipkin\BinaryAnnotation',
            ),
          ),
        9 => array(
          'var' => 'debug',
      ...
      switch ($fid)
      {
        ...
        case 6:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Shared\Libraries\Jaeger\Thrift\Zipkin\Annotation();
        ...
        case 8:
          if ($ftype == TType::LST) {
            ...
            {
              $elem11 = null;
              $elem11 = new \Shared\Libraries\Jaeger\Thrift\Zipkin\BinaryAnnotation();
