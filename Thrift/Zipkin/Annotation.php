...
class Annotation {
   ...
   * 
   * @var \Shared\Libraries\Jaeger\Thrift\Zipkin\Endpoint
   */
  public $host = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          'var' => 'host',
          'type' => TType::STRUCT,
          'class' => '\Shared\Libraries\Jaeger\Thrift\Zipkin\Endpoint',
          ),
        );
    }
    if (is_array($vals)) {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->host = new \Shared\Libraries\Jaeger\Thrift\Zipkin\Endpoint();
