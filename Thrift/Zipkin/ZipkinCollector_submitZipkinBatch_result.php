...
class ZipkinCollector_submitZipkinBatch_result {
  ...
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\Zipkin\Response[]
   */
  public $success = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Shared\Libraries\Jaeger\Thrift\Zipkin\Response',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem26 = null;
              $elem26 = new \Shared\Libraries\Jaeger\Thrift\Zipkin\Response();
