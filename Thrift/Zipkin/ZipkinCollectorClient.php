...
class ZipkinCollectorClient implements \Shared\Libraries\Jaeger\Thrift\Zipkin\ZipkinCollectorIf {
  ...
  {
    $args = new \Shared\Libraries\Jaeger\Thrift\Zipkin\ZipkinCollector_submitZipkinBatch_args();
    $args->spans = $spans;
  ...
  public function recv_submitZipkinBatch()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Shared\Libraries\Jaeger\Thrift\Zipkin\ZipkinCollector_submitZipkinBatch_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Shared\Libraries\Jaeger\Thrift\Zipkin\ZipkinCollector_submitZipkinBatch_result();
