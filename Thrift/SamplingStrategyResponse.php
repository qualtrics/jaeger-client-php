...
class SamplingStrategyResponse {
  ...
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\ProbabilisticSamplingStrategy
   */
  public $probabilisticSampling = null;
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\RateLimitingSamplingStrategy
   */
  public $rateLimitingSampling = null;
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\PerOperationSamplingStrategies
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          ...
          'type' => TType::STRUCT,
          'class' => '\Shared\Libraries\Jaeger\Thrift\ProbabilisticSamplingStrategy',
          ),
        3 => array(
          'var' => 'rateLimitingSampling',
          'type' => TType::STRUCT,
          'class' => '\Shared\Libraries\Jaeger\Thrift\RateLimitingSamplingStrategy',
          ),
        4 => array(
          'var' => 'operationSampling',
          'type' => TType::STRUCT,
          'class' => '\Shared\Libraries\Jaeger\Thrift\PerOperationSamplingStrategies',
          ),
        );
    }
    if (is_array($vals)) {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->probabilisticSampling = new \Shared\Libraries\Jaeger\Thrift\ProbabilisticSamplingStrategy();
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->rateLimitingSampling = new \Shared\Libraries\Jaeger\Thrift\RateLimitingSamplingStrategy();
        ...
        case 4:
          if ($ftype == TType::STRUCT) {
            $this->operationSampling = new \Shared\Libraries\Jaeger\Thrift\PerOperationSamplingStrategies();
