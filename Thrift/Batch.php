...
class Batch {
  ...
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\Process
   */
  public $process = null;
  /**
   * @var \Shared\Libraries\Jaeger\Thrift\Span[]
   */
  public $spans = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'process',
          'type' => TType::STRUCT,
          'class' => '\Shared\Libraries\Jaeger\Thrift\Process',
          ),
        2 => array(
          'var' => 'spans',
          'type' => TType::LST,
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Shared\Libraries\Jaeger\Thrift\Span',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->process = new \Shared\Libraries\Jaeger\Thrift\Process();
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem40 = null;
              $elem40 = new \Shared\Libraries\Jaeger\Thrift\Span();
