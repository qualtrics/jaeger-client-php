...
class CollectorClient implements \Shared\Libraries\Jaeger\Thrift\CollectorIf {
  ...
  {
    $args = new \Shared\Libraries\Jaeger\Thrift\Collector_submitBatches_args();
  ...
  public function recv_submitBatches()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Shared\Libraries\Jaeger\Thrift\Collector_submitBatches_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Shared\Libraries\Jaeger\Thrift\Collector_submitBatches_result();
