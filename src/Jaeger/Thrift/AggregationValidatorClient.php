...
class AggregationValidatorClient implements \Jaeger\Thrift\AggregationValidatorIf
{
    ...
    {
        $args = new \Jaeger\Thrift\AggregationValidator_validateTrace_args();
    ...
    public function recv_validateTrace()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Jaeger\Thrift\AggregationValidator_validateTrace_result', $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Jaeger\Thrift\AggregationValidator_validateTrace_result();
