...
class SamplingManagerClient implements \Jaeger\Thrift\SamplingManagerIf
{
    ...
    {
        $args = new \Jaeger\Thrift\SamplingManager_getSamplingStrategy_args();
    ...
    public function recv_getSamplingStrategy()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Jaeger\Thrift\SamplingManager_getSamplingStrategy_result', $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Jaeger\Thrift\SamplingManager_getSamplingStrategy_result();
