...
class Span
{
  ...
  /**
   * @var \Jaeger\Thrift\Zipkin\Annotation[]
   */
    public $annotations = null;
  /**
   * @var \Jaeger\Thrift\Zipkin\BinaryAnnotation[]
   */
   ...
   */
    ...
    public function __construct($vals = null)
    {
        if (!isset(self::$_TSPEC)) {
            ...
            'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Jaeger\Thrift\Zipkin\Annotation',
            ),
            ),
            8 => array(
            ...
            'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Jaeger\Thrift\Zipkin\BinaryAnnotation',
            ),
            ),
            9 => array(
            'var' => 'debug',
                ...
                case 6:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i4 = 0; $_i4 < $_size0; ++$_i4) {
                            $elem5 = null;
                            $elem5 = new \Jaeger\Thrift\Zipkin\Annotation();
                ...
                case 8:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i10 = 0; $_i10 < $_size6; ++$_i10) {
                            $elem11 = null;
                            $elem11 = new \Jaeger\Thrift\Zipkin\BinaryAnnotation();
