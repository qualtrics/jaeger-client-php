...
class ZipkinCollectorClient implements \Jaeger\Thrift\Zipkin\ZipkinCollectorIf
{
    ...
    {
        $args = new \Jaeger\Thrift\Zipkin\ZipkinCollector_submitZipkinBatch_args();
        $args->spans = $spans;
    ...
    public function recv_submitZipkinBatch()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Jaeger\Thrift\Zipkin\ZipkinCollector_submitZipkinBatch_result', $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Jaeger\Thrift\Zipkin\ZipkinCollector_submitZipkinBatch_result();
