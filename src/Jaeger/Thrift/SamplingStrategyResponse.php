...
class SamplingStrategyResponse
{
  ...
  /**
   * @var \Jaeger\Thrift\ProbabilisticSamplingStrategy
   */
    public $probabilisticSampling = null;
  /**
   * @var \Jaeger\Thrift\RateLimitingSamplingStrategy
   */
    public $rateLimitingSampling = null;
  /**
   * @var \Jaeger\Thrift\PerOperationSamplingStrategies
   */
    ...
    public function __construct($vals = null)
    {
        if (!isset(self::$_TSPEC)) {
            ...
            'type' => TType::STRUCT,
            'class' => '\Jaeger\Thrift\ProbabilisticSamplingStrategy',
            ),
            3 => array(
            'var' => 'rateLimitingSampling',
            'type' => TType::STRUCT,
            'class' => '\Jaeger\Thrift\RateLimitingSamplingStrategy',
            ),
            4 => array(
            'var' => 'operationSampling',
            'type' => TType::STRUCT,
            'class' => '\Jaeger\Thrift\PerOperationSamplingStrategies',
            ),
            );
        }
        if (is_array($vals)) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->probabilisticSampling = new \Jaeger\Thrift\ProbabilisticSamplingStrategy();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->rateLimitingSampling = new \Jaeger\Thrift\RateLimitingSamplingStrategy();
                ...
                case 4:
                    if ($ftype == TType::STRUCT) {
                        $this->operationSampling = new \Jaeger\Thrift\PerOperationSamplingStrategies();
